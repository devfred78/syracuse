...
def main():
	...
	print("***********************************************************")
	print("*                     Test n°5_1                          *")
	print("* Total stopping time computation for a range of sequences*")
	print("*                                                         *")
	...
	total_stopping_times_tuple = syracuse.Syracuse.total_stopping_times_range(max_initial_value, min_initial_value)
	...
	start = time.perf_counter_ns()
	total_stopping_times_tuple = syracuse.Syracuse.total_stopping_times_range(max_initial_value, min_initial_value, parallel = True)
	end = time.perf_counter_ns()
