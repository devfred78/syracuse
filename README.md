...
![Matplotlib graphical view of the successive values of the sequence Syracuse(27)](assets/graph_sequence_27_reduced.png)
...
Distributed under the MIT License. Check out [LICENSE.md](LICENSE.md) file for more information.
